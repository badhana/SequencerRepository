 ...
 *
 */
@DynamoDBTable(tableName="AccessionRevisionItem")
public class AccessionRevisionItem implements Comparable<AccessionRevisionItem>, Serializable{
	 ...
	 */
	@DynamoDBAttribute(attributeName="AccessionNumber")  
	...
	@Override
	public int compareTo(AccessionRevisionItem accessionRevision2) {
	...
	public String toString() {
		return "AccessionRevisionItem [id=" + id + ", accessionNumber="
